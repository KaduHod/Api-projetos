export const projects = [
    {
      ...
      "repositorie": [
        "https://github.com/KaduHod/watch-sync-videos/tree/client-branch",
        "https://github.com/KaduHod/watch-sync-videos/tree/server-branch"
      ],
      "technologies": [
        {
          "name": "Node",
        ...
        {
          "name": "html",
          "type": "hypertext language marcation"
        },
        {
          "name": "Css",
          "type": "Sheet style language"
        },
        {
          "name": "Web-socket",
          "type": "Web protocol"
    ...
    },
    {
      ...
      "repositorie": [
        "https://github.com/KaduHod/Brisamar",
        "https://github.com/KaduHod/API"
      ],
      "technologies": [
        {
          "name": "Node",
